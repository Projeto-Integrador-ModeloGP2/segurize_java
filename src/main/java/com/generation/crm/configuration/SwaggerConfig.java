...
public class SwaggerConfig {
    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Projeto Soluções em Seguros")
            ...
            .externalDocs(new ExternalDocumentation()
                .description("Github (Projeto Soluções em Seguros)")
                .url("https://github.com/Projeto-Integrador-ModeloGP2/crm-solucoes-em-seguros"));
    }
